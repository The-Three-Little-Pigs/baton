                    ...
                    child: Column(
                      ...
                      children: [
                                              ...
                                              child: Text(
                                                ...
                                                style: TextStyle(
                                                  color: post.status ==
                                                      ...
                                                      : post.status ==
                                                              ProductStatus.sold
                                                          ? const Color(0xFF5E6876)
                                                          : const Color(0xFF2CD38B),
                                                  fontSize: 12,
                                                  fontWeight: FontWeight.bold,
                                                ),
                                              ),
                        ...
                        if (!isEditMode) ...[
                          ...
                          if (post.status == ProductStatus.sold) ...[
                            // 거래완료 상태일 때: 후기 보내기 버튼
                            const SizedBox(height: 12),
                            SizedBox(
                              ...
                              child: OutlinedButton(
                                onPressed: () async {
                                  ...
                                  final receiverId = post.authorId;
                                  final userIds = [myUid, receiverId]..sort();
                                  final roomId =
                                      '${userIds[0]}_${userIds[1]}_${post.postId}';

                                  // 상대방(판매자) 닉네임 가져오기
                                  final opponent = await ref
                                      .read(authorProvider(receiverId).future);
                                  ...
                                  if (context.mounted) {
                                    context.push(
                                      ...
                                      extra: {
                                        ...
                                        'productPrice':
                                            (post.salePrice ?? 0).toString(),
                                        'productImageUrl': post.imageUrls.isNotEmpty
                                            ? post.imageUrls[0]
                                            : null,
                                        'confirmedAt': post.createdAt,
                                      },
                                    );
                                  }
                                },
